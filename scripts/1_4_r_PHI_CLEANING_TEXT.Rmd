...
```{r, echo = FALSE }
resp = request("PHI_dated_2020-06-23.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/PHI/", method="GET", cred=c(user, getPass("your sciencedata password: ")))
```
...
write(PHI_cleaned_json, file="PHI_cleaned_2020-06-26.json")
user <- readline("your sciencedata username: ")
request("PHI_cleaned_2020-06-26.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/PHI/",
...
```{r}
 file.remove("PHI_cleaned_2020-06-26.json") # removes local copy
```
