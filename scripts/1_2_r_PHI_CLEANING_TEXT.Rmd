...
```{r, echo = FALSE }
resp = request("PHI_enriched_2020-06-29.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/PHI/", method="GET", cred=c(user, getPass("your sciencedata password: ")))
```
...
PHI_cleaned_json <- jsonlite::toJSON(PHI_clean) 


write(PHI_cleaned_json, file="PHI_cleaned_2020-06-29.json")
user <- readline("your sciencedata username: ")
request("PHI_cleaned_2020-06-29.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/PHI/",
...
```{r}
 file.remove("P./HI_cleaned_2020-06-269json") # removes local copy
```
