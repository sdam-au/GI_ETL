...
write(PHI_cleaned_json, file="PHI_cleaned_2020-08-27.json")
user <- readline("your sciencedata username: ")
request("PHI_cleaned_2020-08-27.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/PHI/",
...
```{r}
 file.remove("./PHI_ccleand_2020-08-27.json") # removes local copy
```
