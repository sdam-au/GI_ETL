...
**Aim:** All instances of special characters typical for Pythia PHI dataset cleaned (substituted with " ".)
...
Download the data to the data/large_data folder manually. Get access from the authors, or load your own dataset. 
Display the first six records (head)

```{r}
list_json <- jsonlite::read_json("../data/large_data/PHI_with_pythia_20201216.json")
...
Alternative: Saving to Sciencedata
