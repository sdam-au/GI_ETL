...
```{r, echo = FALSE }
resp = request("PHI_sample.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/PHI/", method="GET", cred=c(user, getPass("your sciencedata password: ")))
```
...
PHI_cleaned_json <- toJSON(PHI_clean)
 rite(PHI_cleaned_json, file="PHI_cleaned_sample.json")
 user <- readline("your sciencedata username: ")
