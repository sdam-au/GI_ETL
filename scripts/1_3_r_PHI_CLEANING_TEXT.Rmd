...
```{r, echo = FALSE }
resp = request("PHI_sample_utf8.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/PHI/", method="GET", cred=c(user, getPass("your sciencedata password: ")))
```
...
### Adding all three versions of the cleaned text to the original dataset
...
PHI_cleaned_json <- rjson::toJSON(PHI_clean) # error in rjson::toJSON(PHI_clean) : unable to escape string. String is not utf8

write(PHI_cleaned_json, file="PHI_cleaned_sample.json")
user <- readline("your sciencedata username: ")
equest("PHI_cleaned_sample.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/PHI/",
...
```{r}
remove("PHI_cleaned_sample.json") # removes local copy
```
